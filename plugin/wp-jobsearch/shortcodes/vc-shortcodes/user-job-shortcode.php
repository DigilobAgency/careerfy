            ...
            <form autocomplete="off" id="<?php echo apply_filters('jobsearch_job_posting_form_id', 'job-posting-form') ?>"
                ...
                <div class="jobsearch-employer-box-section">
                    ...
                    <?php } else { ?>
                        <div class="jobsearch-profile-title">
                            <?php
                            if ($is_updating) { ?>
                                <h2><?php printf(esc_html__('Job "%s"', 'wp-jobsearch'), esc_attr(get_the_title($job_id))) ?></h2>
                                <?php
                            } else { ?>
                    ...
                    if ($free_jobs_allow != 'on' && $is_updating && isset($_GET['step']) && $_GET['step'] == 'package') {
                        ...
                        $packages_list = apply_filters('jobsearch_emp_postjob_pkg_job_metakey', array('job', 'featured_jobs', 'emp_allin_one', 'employer_profile'));
                                    ...
                                    <tr>
                                        <td>
                                            <div class="jobsearch-payments-checkbox">
                                                <input data-pkg_type="<?php echo esc_attr($pkg_type);?>" id="pkg-<?php echo absint($pkg_rand) ?>" <?php echo($featjob_pkg_clas) ?>
                        ...
                        <div class="jobsearch-employer-payments">
                                ...
                                <table class="buynew-plans-list">
                                    ...
                                    foreach ($pkgs_qposts as $pkg_id) {
                                        ...
                                        if ($pkg_attach_product != '' && get_page_by_path($pkg_attach_product, 'OBJECT', 'product')) {
                                            ...
                                            } else if ($pkg_otype == 'featured_jobs' || $pkg_otype == 'featured_tags') {
                                            ...
                                            <tr id="buy-newpkgitem-<?php echo absint($pkg_rand) ?>"<?php echo($is_pckg_subscribed ? ' class="pkg-disabled"' : '') ?>>
                                                <td>
                                                    <div class="jobsearch-payments-checkbox">
                                                        <input data-pkg_type="<?php echo esc_attr($pkg_otype);?>" id="pkg-<?php echo absint($pkg_rand) ?>"
                                                ...
                                                if ($pkg_otype == 'emp_allin_one' || $pkg_otype == 'featured_jobs' || $pkg_otype == 'employer_profile') {
                                                    ...
                                                    <?php
                                                } elseif ($pkg_otype == 'featured_tags'){
                                                    ?>
                                                   <td>
                                                        <?php printf(esc_html__('Featured Credits: %s', 'wp-jobsearch'), $total_fjobs) ?>
                                                    </td>
                            ...
                            <script>
                                ...
                                jQuery('.alexist-plans-list').find('input[type="checkbox"]').on('change', function () {
                                    //
                                    var pkg_slected = false;
                                    jQuery('.alexist-plans-list').find('input[type="checkbox"]').each(function() {
                                        if (jQuery(this).is(':checked')) {
                                            pkg_slected = true;
                                        }
                                    });
                                    jQuery('.buynew-plans-list').find('input[type="checkbox"]').each(function() {
                                        if (jQuery(this).is(':checked')) {
                                            pkg_slected = true;
                                        }
                                    });
                                    if (pkg_slected == true) {
                                        jQuery('.aditional-featurejob-pkgs').removeAttr('style');
                                    } else {
                                        jQuery('.aditional-featurejob-pkgs').hide();
                                    }
                                });
                                jQuery('.buynew-plans-list').find('input[type="checkbox"]').on('change', function () {
                                    //
                                    var pkg_slected = false;
                                    jQuery('.alexist-plans-list input[type="checkbox"]').each(function() {
                                        if (jQuery(this).is(':checked')) {
                                            pkg_slected = true;
                                        }
                                    });
                                    jQuery('.buynew-plans-list input[type="checkbox"]').each(function() {
                        ...
                        if (!empty($fpkgs_posts)) {
                            ob_start();
                            ?>
                            <div class="jobsearch-employer-payments aditional-featurejob-pkgs" style="display: none;">
                            ...
                            <script>
                                jQuery(document).ready(function () {
                                    ...
                                    jQuery('#jobsearch_job_application_deadline').datetimepicker({
                                        timepicker: true,
                                        format: '<?php echo apply_filters('jobsearch_job_post_deadlinedate_format', 'd-m-Y') ?>',
                                        <?php
                            ...
                            <ul class="jobsearch-row jobsearch-employer-profile-form">
                                ...
                                if ($fill_field && $job_allow_filled == 'on') { ?>
                                    <li class="<?php echo($fil_col_class) ?>">
                                        ...
                                        <div class="jobsearch-profile-select">
                                            <select name="job_filled" class="selectize-select jobsearch_job_filled_select" data-job_id="<?php echo intval($job_id);?>">
                                ...
                                if ($dropdown_flag) {
                                    ...
                                    ?>
                                    <li class="jobsearch-column-6">
                                        <?php echo jobsearch_add_field_label_tooltip(esc_html__('Job Apply Type' . ($jobapply_type_req == 'on_req' ? ' *' : ''), 'wp-jobsearch'), 'emp_dashb_job_apply_type_tooltip') ?>
                                        <div class="jobsearch-profile-select">
                                    ...
                                    <li class="jobsearch-column-12">
                                        ...
                                        <div class="salary-input salary-input-fordev<?php echo($salary_onoff_switch == 'on_req' ? ' required-field' : '') ?>"
                                            ...
                                            <div class="min-salary">
                                                ...
                                                <input type="number" min="0" step="1" onkeypress="return isNumberKey(this, event);" placeholder="<?php esc_html_e('Min', 'wp-jobsearch') ?>"
                                                       name="job_salary" <?php echo('value="' . jobsearch_esc_html($_job_salary) . '"') ?>>
                                            </div>
                                            <div class="max-salary">
                                                <span><?php echo($_job_currency_sym); ?></span>
                                                <input type="number" min="0" step="1" onkeypress="return isNumberKey(this, event);" placeholder="<?php esc_html_e('Max', 'wp-jobsearch') ?>"
                ...
                if (!$is_candidate) {
                    if (isset($job_detail_tab) && $job_detail_tab && !isset($_GET['step'])) {
                        ...
                        do_action('jobsearch_dashboard_acf_fields_load', $job_id, 'job');                        
