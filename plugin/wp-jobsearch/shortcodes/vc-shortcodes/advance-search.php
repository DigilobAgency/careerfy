                ...
                <ul>
                    ...
                    if ($keyword_field == 'show') {
                        ...
                        <li>
                            <div class="<?php echo ($autofill_keyword == 'yes' ? 'jobsearch-sugges-search' : '') ?>">
                                <input placeholder="<?php echo apply_filters('jobsearch_own_sh_adv_srch_keywords_str', esc_html__('Job Title, Keywords, or Phrase', 'wp-jobsearch')) ?>" class="jobsearch-keywordsrch-inp-field" data-type="<?php echo ($autofill_sugg_type) ?>" name="search_title" type="text">
                            ...
                            <li>
                                <div class="jobsearch_searchloc_div">
                                    ...
                                    if ($autofill_location == 'yes') {
                                        ...
                                        ?>
                                        <input placeholder="<?php esc_html_e('Location', 'wp-jobsearch') ?>"
                                ...
                                if ($auto_geo_location == 'yes') {
                                    ...
                                    <a href="javascript:void(0);" class="geolction-btn"
                                       onclick="JobsearchGetClientLocation()"><i class="jobsearch-icon jobsearch-location"></i></a>
                                <?php } ?>
                            </li>
                            <?php
                        } else {
                        ...
                        <li>
                            <div class="jobsearch-select-style">
                                <select name="sector_cat" class="<?php echo apply_filters('jobsearch_advsrchbox_sh_selsector_classes', 'selectize-select') ?>">
                                    ...
                                    <option value="all"><?php esc_html_e('All', 'wp-jobsearch') ?></option>
                    ...
                    if ($serch_btn_txt != '') {
                        ...
                        <li class="jobsearch-banner-submit">
                            <button type="submit">
                                 <i class="jobsearch-icon jobsearch-search"<?php echo($srch_btn_style) ?>></i>
                            </button>
                        </li>
                        <?php
                    }
