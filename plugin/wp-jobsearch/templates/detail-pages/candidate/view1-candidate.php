...
if (empty($user_displayname)) {
    $user_displayname = get_the_title($candidate_id);
}
if ($cand_profile_restrict::cand_field_is_locked('profile_fields|display_name', 'detail_page')) {
    $user_displayname = $cand_profile_restrict::cand_restrict_display_name($candidate_id);
}
...
if (!$cand_profile_restrict::cand_field_is_locked('profile_fields|cover_img', 'detail_page')) {
    if ($candidate_id != '') {
        ...
        if ($candidate_cover_image_src != '') {
            $candidate_cover_image_src_style_str = ' style="background:url(\'' . ($candidate_cover_image_src) . '\') center/cover no-repeat; "';
        }
    }
}
...
<div class="jobsearch-main-content">
    ...
    <div class="jobsearch-main-section">
        <div class="jobsearch-plugin-default-container" <?php echo ($plugin_default_view_with_str); ?>>
            <?php echo apply_filters('jobsearch_candetail_on_top_extrahtml', '', $candidate_id) ?>
            <div class="jobsearch-row">
                <?php
                if ($view_candidate === false) {
                                ...
                                <div class="login-btns">
                                    ...
                                    if ($op_emp_register_allow != 'no') {
                                        ...
                                        <a href="javascript:void(0);"
                                           class="jobsearch-open-register-tab company-register-tab"><i class="jobsearch-icon jobsearch-plus"></i><?php esc_html_e('Become an Employer', 'wp-jobsearch') ?>
                                        </a>
                                        <?php
                                    }
                                    ?>
                    ...
                    $candidate_sector = array();
                    foreach ($sectors as $sector) {
                        $candidate_sector[] = $sector->name;
                    }
                    $candidate_sector_str = implode(', ', $candidate_sector);
                    ...
                    <aside class="jobsearch-column-4 jobsearch-typo-wrap">
                        <div class="jobsearch_side_box jobsearch_box_candidate_info jobsearch-view1-candidate-style">
                            <div class="jobsearch_candidate_info">
                                ...
                                ?>
                                <h2>
                                    <?php echo apply_filters('jobsearch_candidate_detail_side_displayname', $user_displayname, $candidate_id) ?>
                                </h2>
                                <?php
                                if (!$cand_profile_restrict::cand_field_is_locked('profile_fields|job_title', 'detail_page')) {
                                    ob_start();
                                    ?>
                                    <strong class="jobsearch-cand-jobtitle"><?php echo apply_filters('jobsearch_cand_jobtitle_indisplay', $candidate_jobtitle, $candidate_id) ?></strong>
                                    <?php
                                ...
                                $phn_html = ob_get_clean();
                                echo apply_filters('jobsearch_candetail_phn_number_html', $phn_html, $candidate_id);
                                if (!$cand_profile_restrict::cand_field_is_locked('profile_fields|sector', 'detail_page')) {
                                    if ($candidate_sector != '' && $sectors_enable_switch == 'on') {
                                        echo '<p>' . sprintf(esc_html__('Sector: %s', 'wp-jobsearch'), apply_filters('jobsearch_gew_wout_anchr_sector_str_html', $candidate_sector_str, $candidate_id)) . '</p>';
                                    }
                                }
                                ...
                                if ($candidate_join_date != '') { 
                                    ...
                                    <?php
                                    $dobhtml = ob_get_clean();
                                    echo apply_filters('jobsearch_candetail_member_since_html', $dobhtml, $candidate_id);
                                }
                                
                                echo apply_filters('jobsearch_candetail_before_social_info_html', '', $candidate_id);
                            ...
                            <?php
                                do_action('jobsearch_before_download_candetail_cv_btn', $candidate_id);
                                do_action('jobsearch_download_candidate_cv_btn', array('id' => $candidate_id));
                                do_action('jobsearch_after_download_candetail_cv_btn', $candidate_id);
                            ?>
                        </div>
                    ...
                    <div class="jobsearch-column-8 jobsearch-typo-wrap">
                        <div class="container-wrapper container-wrapper-view1">
                            <div class="jobsearch-candidate-editor">
                                ...
                                $display_name_txt = sprintf(esc_html__('About %s', 'wp-jobsearch'), $show_disp_name);
                                ?>
                                <div class="jobsearch-content-title">
                                    <h2><?php echo apply_filters('jobsearch_candetail_content_displayname_text', $display_name_txt, $show_disp_name, $candidate_id) ?></h2>
                                </div>
                                <?php
                                    ...
                                    <div class="jobsearch-jobdetail-services">
                                        <ul class="jobsearch-row">
                                            ...
                                            if ($page_views == 'on') {
                                                ...
                                                <?php
                                                $vcounthtml = ob_get_clean();
                                                echo apply_filters('jobsearch_candetail_views_count_html', $vcounthtml, $candidate_id);
                                            }
                                            do_action('jobsearch_candetail_after_views_count_html', $candidate_id);
                                            ?>
                                        </ul>
                                    </div>
                                    <?php
                                ...
                                echo do_action('jobsearch_acf_job_content_fields', $candidate_id, 'candidate');
                                ...
                                if ($candidate_content != '') {
                                    if (!$cand_profile_restrict::cand_field_is_locked('profile_fields|about_desc', 'detail_page')) {
                                        ...
                                        ?>
                                        <div class="jobsearch-content-title">
                                            <h2><?php echo apply_filters('jobsearch_candetail_aboutme_heading', esc_html__('About me', 'wp-jobsearch')) ?></h2>
                                        </div>
                                            ...
                                            foreach ($exfield_list as $exfield) {
                                                ...
                                                <li class="jobsearch-column-12">
                                                    ...
                                                    <div class="jobsearch-candidate-timeline-text">
                                                        ...
                                                        <p><?php echo jobsearch_esc_wp_editor($exfield_val) ?></p>
                                                    </div>
                                                </li>
                                                <?php
                                                $exfield_counter++;
                                ...
                                <div class="jobsearch_progressbar_wrap jobsearch-candidate-langs">
                                    <div class="jobsearch-row">
                                        ...
                                        foreach ($exfield_list as $exfield) {
                                            ...
                                            $lang_percentagefield_val   = apply_filters('jobsearch_candet_resume_lang_percentage_val_filter', $lang_percentagefield_val, $lang_level_val);
                                            ?>
                                            <div class="jobsearch-column-4">
                                                        ...
                                                        <figcaption>
                                                            <div class="img-icons">
                                                                <a href="<?php echo($portfolio_vurl != '' ? $portfolio_vurl : $port_thumb_img) ?>"
                                                                   ...
                                                                   data-fancybox-group="group"><i class="<?php echo($portfolio_vurl != '' ? 'fa fa-play' : 'fa fa-image') ?>"></i></a>
                                                                <?php
                                                                if ($portfolio_url != '') { ?>
                            ...
                            jobsearch_detail_common_ad_code($ad_args);                            
                            echo apply_filters('jobsearch_candidate_detail_after_portfolio_html', '', $candidate_id);
                            ...
                            echo apply_filters('jobsearch_candetail_before_skills_afiltr', '', $candidate_id);
