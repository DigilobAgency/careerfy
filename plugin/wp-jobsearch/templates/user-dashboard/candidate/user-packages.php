    ...
    <div class="jobsearch-employer-dasboard">
        <div class="jobsearch-employer-box-section">
            ...
            if (class_exists('WooCommerce')) {
                ...
                $total_pkgs = $pkgs_query_posts->total;
            }
                                                ...
                                                <tr class="pakcge-itm-footr">
                                                    <td class="pakcge-active-date" colspan="2">
                                                        <div class="date-sec">
                                                            ...
                                                            <?php
                                                            $order_created_date = date_i18n(get_option('date_format'), strtotime($order_created_date));
                                                            printf(esc_html__('Purchase Date: %s', 'wp-jobsearch'), $order_created_date);
                                                            ?>
                                                        </div>
                                                    </td>
