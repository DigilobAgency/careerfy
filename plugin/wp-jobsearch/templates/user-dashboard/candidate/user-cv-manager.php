...
if ($candidate_id > 0) {
    ...
    ?>
    <div class="jobsearch-employer-box-section candidate_cv_skillid">
                                    ...
                                    <li class="jobsearch-column-12">
                                        <div class="jobsearch-cv-manager-wrap">
                                            ...
                                            <div class="jobsearch-cv-manager-text">
                                                ...
                                                <a href="<?php echo ($file_url) ?>" class="jobsearch-cv-manager-link jobsearch-cv-manager-download" oncontextmenu="javascript: return false;" onclick="javascript: if ((event.button == 0 && event.ctrlKey)) {return false};" download="<?php echo ($filename) ?>"><i class="<?php echo apply_filters('jobsearch_cand_pages_downlod_cv_icon', 'jobsearch-icon jobsearch-download-arrow', $candidate_id) ?>"></i></a>
                                                <?php echo apply_filters('jobsearch_candash_cvmnger_downlod_btn_after', '', $cv_file_val, $candidate_id) ?>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            jQuery('#cvFilesDropzone').dropzone({
                                ...
                                init: function() {
                                    this.on("sending", function(file, xhr, formData) {
                                        ...
                                        jQuery('#cvFilesDropzone .jobsearch-drpzon-btn').append('<span class="fa fa-refresh fa-spin"></span>')
                                    });
                                    this.on("complete", function(file) {
                                        ...
                                        jQuery('.jobsearch-drpzon-btn span').remove();
                                    });
                                },
                            ...
                            jQuery('#cvFilesDropzone').dropzone({
                                ...
                                init: function() {
                                    ...
                                    this.on("complete", function(file) {
                                        ...
                                        jQuery('#cvFilesDropzone .jobsearch-drpzon-btn span').remove();
                                    });
                                },
                                queuecomplete: function() {
                                    jQuery('#cvFilesDropzone .jobsearch-drpzon-btn span').remove();
                                ...
                                <li class="jobsearch-column-12">
                                    <div class="jobsearch-cv-manager-wrap">
                                        ...
                                        <div class="jobsearch-cv-manager-text">
                                            ...
                                            <a href="javascript:void(0);" class="jobsearch-cv-manager-link jobsearch-del-user-cv" data-id="<?php echo ($file_uniqid) ?>"><i class="jobsearch-icon jobsearch-rubbish"></i></a>
                                            <a href="<?php echo ($file_url) ?>" class="jobsearch-cv-manager-link jobsearch-cv-manager-download" oncontextmenu="javascript: return false;" onclick="javascript: if ((event.button == 0 && event.ctrlKey)) {return false};" download="<?php echo ($filename) ?>"><i class="<?php echo apply_filters('jobsearch_cand_pages_downlod_cv_icon', 'jobsearch-icon jobsearch-download-arrow', $candidate_id) ?>"></i></a>
                                            <?php echo apply_filters('jobsearch_candash_cvmnger_downlod_btn_after', '', $candidate_cv_file, $candidate_id) ?>
                                        </div>
                                    </div>
                                </li>
                            </ul>
        ...
        echo do_action('jobsearch_dashboard_after_cv_upload_html', $candidate_id, $page_url);
        ?>
