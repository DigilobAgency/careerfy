...
$field_params['featured_only'] = array(
    'type' => 'select',
...
$field_params['job_custom_fields_switch'] = array(
    'type' => 'select',
...
$field_params['quick_apply_job'] = array(
    'type' => 'select',
...
$field_params['job_loc_listing'] = array(
    'type' => 'multi_checkbox',
...
if ($all_locations_type == 'api') {
    $field_params['selct_loc_jobs'] = array(
        'type' => 'select',
        'label' => esc_html__('Selected Location Jobs', 'wp-jobsearch'),
        'desc' => esc_html__('Show only Selected Location Jobs.', 'wp-jobsearch'),
        'options' => array(
            'no' => esc_html__('No', 'wp-jobsearch'),
            'yes' => esc_html__('Yes', 'wp-jobsearch'),
        )
    );
    $field_params['selct_gapiloc_str'] = array(
        'type' => 'api_loc_select',
        'label' => esc_html__('Location Based Jobs', 'wp-jobsearch'),
        'desc' => esc_html__('Show only Selected Location Jobs.', 'wp-jobsearch'),
    );
}
$field_params['job_deadline_switch'] = array(
    'type' => 'select',
...
$field_params['job_filters'] = array(
    'type' => 'select',
...
$field_params['job_filters_count'] = array(
    'type' => 'select',
...
$field_params['job_filters_keyword'] = array(
    'type' => 'select',
...
$field_params['job_filters_loc'] = array(
    'type' => 'select',
...
$field_params['job_locfilters_sortby'] = array(
    'type' => 'select',
    'label' => esc_html__('Location Filters Sort by', 'wp-jobsearch'),
    'desc' => '',
    'options' => array(
...
$field_params['job_filters_loc_collapse'] = array(
    'type' => 'select',
...
$field_params['job_filters_loc_view'] = array(
    'type' => 'select',
...
$field_params['job_filters_date'] = array(
    'type' => 'select',
...
$field_params['job_datefilters_sortby'] = array(
    'type' => 'select',
    'label' => esc_html__('Posted Date Filters Sort by', 'wp-jobsearch'),
    'desc' => '',
    'options' => array(
        'default' => esc_html__('Default', 'wp-jobsearch'),
        'asc' => esc_html__('Ascending', 'wp-jobsearch'),
...
$field_params['job_filters_date_collapse'] = array(
    'type' => 'select',
...
$field_params['job_filters_type'] = array(
    'type' => 'select',
...
$field_params['job_typefilters_sortby'] = array(
    'type' => 'select',
    'label' => esc_html__('Job Type Filters Sort by', 'wp-jobsearch'),
    'desc' => '',
    'options' => array(
        'default' => esc_html__('Default', 'wp-jobsearch'),
        'asc' => esc_html__('Ascending', 'wp-jobsearch'),
...
$field_params['job_filters_type_collapse'] = array(
    'type' => 'select',
...
$field_params['job_filters_sector'] = array(
    'type' => 'select',
...
$field_params['job_sectorfilters_sortby'] = array(
    'type' => 'select',
    'label' => esc_html__('Sectors Filters Sort by', 'wp-jobsearch'),
    'desc' => '',
    'options' => array(
        'default' => esc_html__('Default', 'wp-jobsearch'),
        'asc' => esc_html__('Ascending', 'wp-jobsearch'),
...
$field_params['job_filters_sector_collapse'] = array(
    'type' => 'select',
...
$field_params['job_filters_skill'] = array(
    'type' => 'select',
...
$field_params['job_skillfilters_sortby'] = array(
    'type' => 'select',
    'label' => esc_html__('Skills Filters Sort by', 'wp-jobsearch'),
    'desc' => '',
    'options' => array(
        'default' => esc_html__('Default', 'wp-jobsearch'),
        'asc' => esc_html__('Ascending', 'wp-jobsearch'),
...
$field_params['job_filters_skill_collapse'] = array(
    'type' => 'select',
...
$field_params['job_top_map'] = array(
    'type' => 'select',
...
$field_params['num_of_feat_jobs'] = array(
    'std' => '5',
    'type' => 'text',
    'label' => esc_html__('Number of Featured jobs', 'wp-jobsearch'),
    'desc' => '',
);
$field_params['job_top_search'] = array(
    'type' => 'select',
...
$field_params['job_top_search_view'] = array(
    'type' => 'select',
...
$field_params['top_search_title'] = array(
    'type' => 'select',
...
$field_params['top_search_location'] = array(
    'type' => 'select',
...
$field_params['top_search_sector'] = array(
    'type' => 'select',
...
$field_params['top_search_autofill'] = array(
    'type' => 'select',
...
$field_params['job_rss_feed'] = array(
    'type' => 'select',
...
$field_params['jobs_emp_base'] = array(
    'type' => 'select',
...
$field_params['jobs_emp_base_id'] = array(
    'std' => '',
    'type' => 'text',
    'label' => esc_html__('Employer ID', 'wp-jobsearch'),
    'desc' => esc_html__('Put employer ID here.', 'wp-jobsearch'),
);
$field_params['job_title_len'] = array(
    'std' => '0',
    'type' => 'text',
    'label' => esc_html__('Title Length', 'wp-jobsearch'),
    'desc' => esc_html__('Set the number of characters you want to show for title. Set 0 for no limit.', 'wp-jobsearch'),
);
$field_params['job_excerpt'] = array(
    'std' => '20',
    'type' => 'text',
...
$field_params['job_orderby'] = array(
    'type' => 'select',
...
$field_params['job_pagination'] = array(
    'type' => 'select',
...
$field_params['job_per_page'] = array(
    'std' => '10',
    'type' => 'text',
...
$jobsearch_builder_shortcodes['job_listings'] = array(
    ...
    'params' => apply_filters('jobsearch_job_listings_sheb_params', $field_params)
);
