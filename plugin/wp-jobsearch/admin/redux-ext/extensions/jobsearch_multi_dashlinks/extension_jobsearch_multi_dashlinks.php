...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_jobsearch_multi_dashlinks' ) ) {
     ...
     * @since       3.1.6
     */
    class ReduxFramework_extension_jobsearch_multi_dashlinks extends ReduxFramework {
        ...
        */
        public function __construct( $parent ) {
            ...
            $this->field_name = 'jobsearch_multi_dashlinks';
            ...
            //
            add_action('wp_ajax_jobsearch_poptions_dashlnk_field_show_icon_cjax', array($this, 'to_show_icon'));
            //
            add_action('wp_ajax_jobsearch_poptions_addmore_dashlnk_field_cjax', array($this, 'add_more_social_field'));
        }
        ...
        public function add_more_social_field() {
            ...
            <div class="upldfield-item">
                <ul>
                    <li>
                        <label><?php esc_html_e('Menu Title', 'wp-jobsearch') ?></label>
