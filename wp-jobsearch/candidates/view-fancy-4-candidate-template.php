...
if (class_exists('JobSearch_plugin')) {
    ...
    ?>
    <div class="careerfy-candidate careerfy-candidate-style8 candiate-search-page-rr"
            ...
            if ($candidate_loop_obj->have_posts()) {
                ...
                foreach ($candidate_loop_obj->posts as $candidate_id) {
                    ...
                    <li class="<?php echo esc_html($columns_class); ?>">
                        <div class="careerfy-candidate-style8-wrapper 00">
                            <?php
                            ...
                            <div class="careerfy-candidate-style8-content">
                                <div class="careerfy-candidate-style8-inner">
                                    <div class="careerfy-candidate-style8-box1">
                                        ...
                                        <?php if (!$cand_profile_restrict::cand_field_is_locked('address_defields')) {
                                            if ($get_candidate_location != '' && $all_location_allow == 'on') { ?>
                                                ...
                                                <i class="jobsearch-icon jobsearch-maps-and-flags"></i><?php echo jobsearch_esc_html($get_candidate_location) ?>
                                            </span>
                                            <?php }

                                        } ?>
                                        </div>
                                        <div><i class="careerfy-icon careerfy-calendar"></i> <span>Member Since:</span> <span><?php echo get_the_date(get_option('date_format'), $candidate_id); ?></span></div>
                                    </div>
                                    <div class="careerfy-candidate-style8-box2">
                                        ...
                                        $update_date = $candidate_post->post_modified;
                                        echo '<div><i class="careerfy-icon careerfy-calendar"></i> <span>Updated:</span> <span>'.date( get_option('date_format'), strtotime( $update_date ) ).'</span></div>';
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="careerfy-candidate-style8-box3">
                                    <div class="details-top-section-rr"> 
                                    <?php do_action('jobsearch_candidate_listing_custom_fields', $atts, $candidate_id, $candidate_arg['custom_fields']); ?>
                                    </div>
                                    <div class="details-bottom-section-rr">
                                        <div class="careerfy-candidate-style8-options">
                                            <?php if (!empty(jobsearch_candidate_current_salary($candidate_id)) && !$cand_profile_restrict::cand_field_is_locked('profile_fields|salary')) { ?>
