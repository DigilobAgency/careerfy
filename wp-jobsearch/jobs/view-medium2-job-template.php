...
$jobsearch_jobs_title_limit = isset($atts['job_title_len']) ? $atts['job_title_len'] : '0';
// start ads script
        ...
        <ul class="row">
            ...
            foreach ($featjobs_posts as $fjobs_post) {
                ...
                <li class="<?php echo($columns_class); ?>">
                    ...
                    <div class="careerfy-featuredjobs-listwrap">
                        <?php
                        ...
                        <div class="careerfy-featured-jobs-list-text">
                            <h2 class="<?php echo($quick_apply_job_btn) ?>"
                                ...
                                <a href="<?php echo $quick_apply_job == 'on' && !wp_is_mobile() ? 'javascript:void(0)' : esc_url(get_permalink($job_id)); ?>"
                                   title="<?php echo get_the_title($job_id); ?>">
                                    <?php echo esc_html(jobsearch__listing_itm_title_limit(get_the_title($job_id), $jobsearch_jobs_title_limit)); ?></a>
                            </h2>
                            <?php
                            ob_start();
                            ?>
                            ...
                            echo apply_filters('jobsearch_empname_in_joblistin', $comp_name_html, $job_id, 'view-medium2');
                            ?>
                            <?php
                            ...
                            if ($job_city_title != '' && $all_location_allow == 'on') {
                                ?>
                                <span> <?php echo jobsearch_esc_html($job_city_title) ?></span>
                                <?php
                            }
...
?>
<div class="careerfy-featured-jobs-list" id="jobsearch-job-<?php echo absint($job_short_counter) ?>">
