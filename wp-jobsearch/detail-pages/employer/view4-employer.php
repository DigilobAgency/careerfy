                    ...
                    <figcaption>
                        ...
                        <ul class="careerfy-jobdetail-options">
                            ...
                            if ((!empty($employer_address) || ($locations_lat != '' && $locations_lng != '')) && $all_location_allow == 'on') {
                                ...
                                if (is_array($map_switchs_arr) && in_array('employer', $map_switchs_arr)) {
                                ...
                                <li>
                                    ...
                                    if (!empty($employer_address)) { ?>
                                        <i class="jobsearch-icon jobsearch-maps-and-flags"></i> <?php echo jobsearch_esc_html($employer_address) ?>
                                    <?php } 
                                    if ($google_mapurl != '') {
                                    ?>
                            ...
                            <ul class="careerfy-employerfour-top-social">
                                ...
                                if ($user_twitter_url != '' && $emp_alow_twt_smm == 'on') {
                                    ...
                                    <li><a href="<?php echo esc_url($user_twitter_url) ?>" target="_blank"
                                           data-original-title="twitter" class="careerfy-icon careerfy-twitter"></a></li>
                                    <?php
                                }
            ...
            <div class="row">
                ...
                <div class="careerfy-column-8 careerfy-typo-wrap jobsearch-typo-wrap">
                    <div class="careerfy-jobdetail-content careerfy-employerdetail-content careerfy-employerdetailfour-content">
                        ...
                        echo do_action('jobsearch_acf_job_content_fields', $employer_id, 'employer');
                                                ...
                                                <div class="careerfy-joblisting-plain-left">
                                                    ...
                                                    <ul>
                                                        ...
                                                        if (isset($job_max_salary) && !empty($job_max_salary)) {
                                                            ?>
                                                            <li>
                                                                <i class="careerfy-icon careerfy-money"></i> <?php echo($job_max_salary); ?>
                                                            </li>
                                                            <?php
                                                        }
                                                        ?>
