                        ...
                        <div class="careerfy-column-8">
                            <div class="careerfy-typo-wrap">
                                    ...
                                    <div class="careerfy-jobdetail-style5-content-list">
                                        ...
                                        <ul>
                                            ...
                                            if ((!empty($get_job_location) || ($locations_lat != '' && $locations_lng != '')) && $all_location_allow == 'on') {
                                                ...
                                                if (is_array($map_switchs_arr) && in_array('job', $map_switchs_arr)) {
                                        ...
                                        if ($social_share_allow == 'on') {
                                            ...
                                            <div class="jobsearch-jobdetail-media-style5">
                                                <?php do_action('jobsearch_job_detail_socilinks_html', $job_id); ?>
                                            </div>
                                            <?php
                                        }
                                ...
                                <div class="careerfy-jobdetail-content careerfy-jobdetail-content-style5">
                                    <?php
                                    $job_id_detail_swich = isset($jobsearch_plugin_options['job_detail_job_id']) ? $jobsearch_plugin_options['job_detail_job_id'] : '';
                                    ...
                                    if ((isset($cus_fields['content']) && $cus_fields['content'] != '') || $job_id_detail_swich == 'on') {
                                        ?>
                                        <div class="careerfy-content-title-style5">
                                            <h2><?php echo esc_html__('Job Detail', 'careerfy') ?></h2>
                                        </div>
                                        <div class="careerfy-jobdetail-services-style5">
                                            <ul class="careerfy-row">
                                                <?php
                                                if ($job_id_detail_swich == 'on') {
                                                    ?>
                                                    <li class="careerfy-column-6">
                                                        <i class="careerfy-icon careerfy-briefcase"></i>
                                                        <div class="careerfy-services-text"><?php esc_html_e('Job ID', 'wp-jobsearch') ?> <small><?php echo ($job_id) ?></small></div>
                                                    </li>
                                                    <?php
                                                }
                                    ...
                                    echo do_action('jobsearch_acf_job_content_fields', $job_id, 'job');
                                    ...
                                    if ($job_attachments_switch == 'on') {
                                        ...
                                        if (!empty($all_attach_files)) {
                                            ob_start();
                                            ?>
                                            <div class="jobsearch-content-title"><h2><?php esc_html_e('Attached Files', 'careerfy') ?></h2></div>
                                            ...
                                            <?php
                                            $attchmnts_html = ob_get_clean();
                                            echo apply_filters('jobsearch_job_detail_atchments_html', $attchmnts_html, $job_id);
                                        }
                                    }
                                        ...
                                        <div class="jobsearch-about-company-style5">
                                            ...
                                            <div class="jobsearch-about-company-content-style5">
                                                <?php if (!empty($user_obj->display_name)) { ?>
                                                    <span><small><?php echo esc_html__('Name: ', 'careerfy') ?></small><?php echo get_the_title($job_employer_id); ?></span>
                                                <?php } ?>
