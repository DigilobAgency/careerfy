        ...
        <div class="careerfy-breadcrumb-style7">
            <div class="container">
                <ul>
                    ...
                    ?>
                    <li><?php echo apply_filters('jobsearch_candidate_detail_side_displayname', $user_displayname, $candidate_id) ?></li>
                </ul>
            </div>
        </div>
                ...
                <?php } else { ?>
                                                    ...
                                                    if ($user_twitter_url != '' && $cand_alow_twt_smm == 'on') { ?>
                                                        <li>
                                                            <a href="<?php echo jobsearch_esc_html(esc_url($user_twitter_url)) ?>"
                                                               target="_blank"
                                                               data-original-title="twitter" class="careerfy-icon careerfy-twitter"></a>
                                                        </li>
                                                        <?php
                                                    }
                    ...
                    <aside class="careerfy-column-4">
                        <div class="careerfy-typo-wrap">
                            ...
                            //
                            ?>
                            <div class="careerfy-canddetail-btn-wrap">
                                <?php
                                ...
                                <div class="jobsearch-cand-details-btns">
                                    ...
                                    if(function_exists('jobsearch_add_employer_resume_to_list_btn')){
