...
.candskills-list li span.insta-match-skill,.careerfy-footer-twentyone .careerfy-footer-widget a.social-icon-footer-twenty:hover {
    ...
    if (!empty($careerfy__options)) {
        ...
        if (isset($menu_link_color['regular']) && $menu_link_color['regular'] != '') {
            ...
            .careerfy-header-twentyone-user>li>a,.careerfy-header-twentyone-strip p  {color: <?php echo esc_html($menu_link_color['regular']) ?>;}
            <?php
        }
        ...
        if ($footer_bg_color != '') {
            ...
            .careerfy-footer-sixteen,.careerfy-footer-thirteen,.careerfy-footer-ninteen,.careerfy-footer-twenty,.careerfy-footer-twentyone,.careerfy-footer-nine {background-color: <?php echo esc_html($footer_bg_color) ?>;}
            <?php
        }
        ...
        if ($footer_border_color != '') {
            ?>
            .careerfy-footer-one .border,.careerfy-footer-widget *,.careerfy-footer-widget .woocommerce.widget *,.careerfy-footer-widget .widget_articles ul li,.careerfy-footer-four .careerfy-footer-widget,.careerfy-footer-partner,.careerfy-footer-two .widget_courses-program ul li,.careerfy-copyright,.copyright-three,.careerfy-copyright-wrap, .careerfy-footer-ten .copyright-ten,.copyright-thirteen,.copyright-sixteen,.copyright-nine {border-color: <?php echo esc_html($footer_border_color) ?>;}
